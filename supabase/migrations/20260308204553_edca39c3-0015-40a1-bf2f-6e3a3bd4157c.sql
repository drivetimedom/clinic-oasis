...
DROP POLICY IF EXISTS "Users can view own memberships" ON clinic_members;

CREATE POLICY "Users can view own memberships" ON clinic_members FOR SELECT TO authenticated USING (user_id = auth.uid());
