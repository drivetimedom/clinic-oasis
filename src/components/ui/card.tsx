...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-2xl border border-border bg-gradient-to-br from-[hsl(0_0%_100%/0.05)] to-transparent shadow-sm transition-all duration-300 hover:border-[hsl(0_0%_100%/0.12)]",
      className
    )}
    {...props}
  />
